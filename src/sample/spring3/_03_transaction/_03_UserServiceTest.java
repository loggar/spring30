...
@ContextConfiguration(locations = "/sample/spring3/_03_transaction/test-UserService_03.xml")
public class _03_UserServiceTest {
	@Autowired private UserDao userDao;
	@Autowired private UserService_03 userService;
	...
	public void setup() {
		users = Arrays.asList(
				new User("loggar", "ChangHee Lee", "pw1", Level.BASIC, UserService_03.MIN_LOGCOUNT_FOR_SILVER - 1, 0),
				new User("loggar2", "ChangHee Lee2", "pw2", Level.BASIC, UserService_03.MIN_LOGCOUNT_FOR_SILVER, 0),
				new User("loggar3", "ChangHee Lee3", "pw3", Level.SILVER, 60, UserService_03.MIN_RECCOMENDCOUNT_FOR_GOLD - 1),
				new User("loggar4", "ChangHee Lee4", "pw4", Level.SILVER, 60, UserService_03.MIN_RECCOMENDCOUNT_FOR_GOLD),
