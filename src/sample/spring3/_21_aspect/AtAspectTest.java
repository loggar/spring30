...
// AopConfigUtils.forceAutoProxyCreatorToUseClassProxying(ac);
	...
	static class HelloAspect {
		@SuppressWarnings("rawtypes") List resultCombine = new ArrayList();
		@SuppressWarnings("rawtypes") List resultReturnString = new ArrayList();
		@SuppressWarnings("rawtypes") List resultHelloClass = new ArrayList();
		@SuppressWarnings("rawtypes") List resultCommon = new ArrayList();
