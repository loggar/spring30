...
/**
 * interface 로 분리 - ConnectionMaker 생성 부분의 분리(test 코드로 위임)
 * 
 */
public class UserDao_05 implements UserDaoInterface_01 {
	private ConnectionMaker connectionMaker;

	public UserDao_05(ConnectionMaker connectionMaker) {
